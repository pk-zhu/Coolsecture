...
def main():
    ...
    p.add_argument("--repeats", type=int, default=5, help="Number of randomization repeats for null/control estimation")
    ...
    def _ratio_arrays_legacy(short_list, resolution):
        ...
        # control percentile and control distance in null model.
        pA = []
        pB = []
        dA = []
        dB = []
